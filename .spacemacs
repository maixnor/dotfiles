...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(docker
     ...
     (wakatime :variables
                wakatime-api-key  "waka_77f1dabe-6db4-4465-8744-b2a1159d6c1b"
...
before packages are loaded."
  ...
  (setq gnus-posting-styles
        '(((header "to" "severin.heugabler@gmail.com")
           (address "severin.heugabler@gmail.com"))))
